<div class="row">
  <div class="x_panel">
    ...
    <div class="x_content" id="dealGroupContainer">
      <?php
        $count_assigned_dealgroups = $isUpdate ? getAssignedDealGroups($dealgroup['entity_id']) : 0;
       ...
       <div class="row">
        ...
        <div class="col-md-2 col-sm-2 col-xs-12 form-group has-feedback">
          <label>Type</label>
          <input type="text" class="form-control has-feedback-right entity_type"  id="type" name="type[]" placeholder="Type" value="<?= ucwords($dealgroup_assigned['type']) ?>" >
