  ...
  <div class="x_panel">
    ...
    <div class="x_content">
      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
        ...
        <input type="text" class="form-control has-feedback-right"  required name="legal_name" placeholder="Legal Name" value="<?= $isUpdate ?  ucwords($entity_details['entity_legal_name']) : ''?>">
      ...
      <div class="col-md-6 col-sm-6 col-xs-12 form-group has-feedback">
        ...
        <input type="text" class="form-control has-feedback-right"  name="incorporation_state" placeholder="Incorporation State" required value="<?= $isUpdate ? ucwords($entity_details['incorporation_state']) : ''?>">
